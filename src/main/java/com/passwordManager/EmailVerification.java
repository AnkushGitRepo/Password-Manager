...
public class EmailVerification {
    ...
    private static boolean sendVerificationEmail(String email, String verificationCode) {
        final String username = "your-user-name@example.com"; // Replace with your email
        final String password = "password"; // Replace with your email password
        ...
        try {
            ...
            message.setFrom(new InternetAddress("your-user-name@example.com")); // Replace with your email
